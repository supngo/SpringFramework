...
public class VaultOperationsTest {
    ...
    public void readShouldRetrieveVaultData() {
        VaultResponse response = this.vaultOperations.read("secret/data/github");
        assertThat(((HashMap<String, String>)response.getData().get("data"))).containsEntry("github.oauth2.key", "foobar");
    }
